        ...
        <div className="col-12">
          <Card className="my-2" color="info" outline>
            ...
            <>
              <CardBody>
                <CardTitle tag="h5">
                  {`${data?.user?.name} (Booking Details)`}
                </CardTitle>
              </CardBody>
              <Table hover>
                <tbody>
                  ...
                  <tr>
                    <td style={{ padding: "10px 20px" }}>{data?.user?.name}</td>
                    <td style={{ padding: "10px 20px" }}>
                      {data?.user?.email}
                    </td>
                    <td style={{ padding: "10px 20px" }}>
                      +
                      {`${data?.booking_data?.travelers[0]?.contact?.phones[0]?.countryCallingCode} - ${data?.booking_data?.travelers[0]?.contact?.phones[0]?.number}`}
                    </td>
                    <td style={{ padding: "10px 20px" }}>
