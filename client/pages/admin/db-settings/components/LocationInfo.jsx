...
const LocationInfo = () => {
  ...
  const validationSchema = Yup.object({
    ...
    twitter_url: Yup.string()
      .required("Twitter URL field is required")
      .matches(
        /^(https?|ftp):\/\/[^\s/$.?#].[^\s]*$/i,
        "Enter a valid URL (e.g., https://www.example.com)"
      ),
  ...
  return (
    <>
      ...
      /> */}
      <form className="col-xl-9" onSubmit={formik.handleSubmit}>
          ...
          <div className="col-6">
            <div className="row">
              {/* <div className="col-5">
                <div>
                  <div className="form-input">
                    <select className="d-flex items-center rounded-4 border-light px-15 text-14"
                      style={{height:'71px'}}
                    >
                    ...
                    <label className="text-16 text-light-1" style={{top:'0px'}}>Country Code</label>
                  </div>
                </div>
              </div> */}
              <div className="col-12">
          ...
          <div className="col-6">
            <div className="form-input ">
              <input
                ...
                onBlur={formik.handleBlur}
              />
              <label className="lh-1 text-16 text-light-1">Facebook URL</label>
            </div>
            {formik.touched.facebook_url && formik.errors.facebook_url && (
              <span className="text-danger">{formik.errors.facebook_url}</span>
            )}
          </div>
          {/* End col-6 */}
          <div className="col-6">
            <div className="form-input ">
              <input
                ...
                onBlur={formik.handleBlur}
              />
              <label className="lh-1 text-16 text-light-1">Linkedin URL</label>
            </div>
            {formik.touched.linkedin_url && formik.errors.linkedin_url && (
              <span className="text-danger">{formik.errors.linkedin_url}</span>
            )}
          </div>
          {/* End col-6 */}
          ...
          <div className="col-6">
            <div className="form-input ">
              <input
                ...
                onBlur={formik.handleBlur}
              />
              <label className="lh-1 text-16 text-light-1">Instagram URL</label>
            </div>
            {formik.touched.instagram_url && formik.errors.instagram_url && (
              <span className="text-danger">{formik.errors.instagram_url}</span>
            )}
          </div>
          {/* End col-6 */}
          ...
          <div className="col-6">
            <div className="form-input ">
              <input
                ...
                onBlur={formik.handleBlur}
              />
              <label className="lh-1 text-16 text-light-1">Twitter URL</label>
            </div>
            {formik.touched.twitter_url && formik.errors.twitter_url && (
              <span className="text-danger">{formik.errors.twitter_url}</span>
            )}
          </div>
          {/* End col-6 */}
