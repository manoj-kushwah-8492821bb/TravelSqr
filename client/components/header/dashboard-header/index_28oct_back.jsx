...
const HeaderDashBoard = () => {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined' && localStorage.getItem('name') !== null) {
      setWelcomeMessage(`Welcome ${localStorage.getItem('name')}`);
    }
  }, []);
        ...
        <div className="header__container px-30 sm:px-20">
          <div className="-left-side">
            <Link href="/" className="header-logo">
              {/* <img src="/img/general/Logo-white.svg" alt="logo icon" /> */}
          ...
          <div className="row justify-between items-center pl-60 lg:pl-20">
            ...
            <div className="col-auto">
              <div className="d-flex items-center">
                ...
                <div className="pl-15" style={{marginRight:'10px',marginBottom:'30px !important'}} >
                  <Image
                    width={50}
                    height={50}
                ...
                <div className="dropdown">
                  <button className="dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false"></button>
                  <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    
                    {router.asPath.includes("/user/") ?
<>
                    <li><Link className="dropdown-item" href="/user/db-settings">Settings</Link></li>
                    <li><button onClick={logoutUser} className="dropdown-item">Logout</button></li>
                    </>:
                    <>
                    <li><Link className="dropdown-item" href="/admin/db-settings">Settings</Link></li>
